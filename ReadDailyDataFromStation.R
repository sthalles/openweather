...
# 
# for (day in 1:31) {
#   print(paste('DAY', day, '       ', st, '-', en,'   ', 'numeric', sep=''))
#   
#   en=en+1
#   
#   print(paste('MFLAG', day, '       ', en, '-', en,'   ', 'character', sep=''))
#   
#   en=en+1
#   
#   print(paste('QFLAG', day, '       ', en, '-', en,'   ', 'character', sep=''))
#   
#   en=en+1
#   
#   print(paste('SFLAG', day, '       ', en, '-', en,'   ', 'character', sep=''))
#   
#   en=en+1
#   
#   st <- en
...
daily.data <- read.fwf("/Users/thalles/Desktop/openweather/CA007075800.dly", widths = Widths, 
                     col.names = Schema$V1, strip.white = TRUE, comment.char = "",
                     colClasses=Schema$V3)

# Each record in a file contains one month of daily data.  The variables on each
# line include the following:
data2014 <- daily.data[daily.data$YEAR == 2014, ]
